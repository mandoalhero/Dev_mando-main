...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("VeGaMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("VeGaMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("VeGaMusic/assets/font.ttf", 30)
    ...
    draw.text((500, 30), f"M A N D O M u S i C", fill="white", stroke_width=1, stroke_fill="black", font=font)
    ...
    play_icons = Image.open("VeGaMusic/assets/play_icons.png")
